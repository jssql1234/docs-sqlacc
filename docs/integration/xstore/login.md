...
If you already have an account, you can <a href="https://ecommerce.sql.com.my/login"><strong>sign in</strong></a> using one of the following methods:
...
Don't have an account yet? Click <a href="https://ecommerce.sql.com.my/register"><strong>Sign up here</strong></a> to create a new account.
...
1. Click **Sign up here** on the sign-in page
   ...
   ![signup-overview](../../../static/img/xstore/login/signup-overview.png)
...
2. Select **Sign up with Email**
   ...
   ![email-overview](../../../static/img/xstore/login/email-overview.png)

3. Enter your **Name** and **valid email address**

4. Click **Sign Up**

   ![email-form](../../../static/img/xstore/login/email-form.png)
...
6. Click the **verification link** in the email
   ...
   ![email-link](../../../static/img/xstore/login/email-link.png)
