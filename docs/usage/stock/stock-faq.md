...
8. GRN Barcode Event.
   ...
   ![6](../../../static/img/stock/stock-faq/barcode/6.png)
...
![cash-drawer](../../../static/img/stock/stock-faq/barcode/cash-drawer.png)

###  Barcode Setting
- To define the barcode setting with a compatible device, eg. barcode printer.
1. **Tools** > **Options** > **Barcode** > **Barcode**.

![barcode-setting](../../../static/img/stock/stock-faq/barcode/barcode-setting.png)
...
barcode-printer-setting
![barcode-printer-setting](../../../static/img/stock/stock-faq/barcode/barcode-printer-setting.png)

1. **Tools** > **Options** > **Barcode** > **Barcode**.
2. Insert the new barcode printer setting and template.

![barcode-printer-setting1](../../../static/img/stock/stock-faq/barcode/barcode-printer-setting1.png)
...
print-barcode-label
![print-barcode-label](../../../static/img/stock/stock-faq/barcode/print-barcode-label.png)
...
![windows-printer](../../../static/img/stock/stock-faq/barcode/windows-printer.png)

###  Update Item Barcode Listing
1. At first, you can update the item bar code in the Maintain Stock Item.
item-barcode-listing

![item-barcode-listing](../../../static/img/stock/stock-faq/barcode/item-barcode-listing.png)

2.Click on + button to insert the items. See the screenshot below.

![item-barcode-listing1](../../../static/img/stock/stock-faq/barcode/item-barcode-listing1.png)
...
![item-barcode-listing2](../../../static/img/stock/stock-faq/barcode/item-barcode-listing2.png)

4. Message prompted. Click OK.

![item-barcode-listing3](../../../static/img/stock/stock-faq/barcode/item-barcode-listing3.png)
...
![item-barcode-listing4](../../../static/img/stock/stock-faq/barcode/item-barcode-listing4.png)

2. Confirmation message prompted. Click on OK to load it. Click on NO' to cancel it.

![item-barcode-listing5](../../../static/img/stock/stock-faq/barcode/item-barcode-listing5.png)

3. Message Load success prompted. Click on OK to proceed.

![item-barcode-listing6](../../../static/img/stock/stock-faq/barcode/item-barcode-listing6.png)

4. You can continue update the new items and save as new file name.

![item-barcode-listing7](../../../static/img/stock/stock-faq/barcode/item-barcode-listing7.png)

###  Preview/Print the Barcode Label
1. . Click on Preview or Printer (to skip the preview).

![preview-barcode-label](../../../static/img/stock/stock-faq/barcode/preview-barcode-label.png)
...
1. Click on the **Report Name**. See the screenshot below.
    ...
    ![10](../../../static/img/stock/stock-faq/change-barcode-label-size/10.png)

2. To change the paper unit measurement. Click on **Report > Units**, choose to **Millimeters**.

    ![11](../../../static/img/stock/stock-faq/change-barcode-label-size/11.png)

3. To change the paper size. Click on **File > Page Setup...**

    ![12](../../../static/img/stock/stock-faq/change-barcode-label-size/12.png)
...
4. Tick out the Output Tax column.
    ...
    ![1](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/1.png)

5. You will see the Output Tax column as per the screenshot below.

    ![2](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/2.png)

6. Click on Output Tax filter.

7. Tick ZRL. All ZRL items will be filtered.

    ![3](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/3.png)

8. **Press Ctrl + A** to select all ZRL items.

9. Right click on the highlighted items. Click on **Batch Edit Value**.

    ![4](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/4.png)

10. Tick Output Tax and select the tax code (SR).

11. Click Ok to proceed the changes.

    ![5](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/5.png)

12. Click **Yes** to confirm update.

    ![6](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/6.png)

13. Click **Ok**.

    ![7](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/7.png)
 
-   **Result**

Items default output tax previously ZRL are **successfully changed to SR**.

![8](../../../static/img/stock/stock-faq/batch-edit-value-stock-item/8.png)

## How to Setup Costing Method 
1. Go to Stock > Maintain Stock Group.

    ![1](../../../static/img/stock/stock-faq/costing-method/1.png)
...
3. If you **change** your costing method (previously with transaction existing).
   ...
   ![2](../../../static/img/stock/stock-faq/costing-method/2.png)
...
1. When purchase the item from supplier, you may choose your branch warehouse (KL) as your location in purchase invoice.
    ...
    ![1](../../../static/img/stock/stock-faq/multi-location/1.png)

2. When you sell out the item, you may choose the location to be sell out from branch warehouse (KL).

    ![2](../../../static/img/stock/stock-faq/multi-location/2.png)
...
3. You will see stock in to branch warehouse (KL) and stock out from branch warehouse (KL) as well when you check your stock card report.
    ...
    ![3](../../../static/img/stock/stock-faq/multi-location/3.png)
...
1. Open a stock transfer documents to transfer the goods from your warehouse (Default) to customer warehouse (Batu Caves).
    ...
    ![4](../../../static/img/stock/stock-faq/multi-location/4.png)
...
1. Go to **Stock > Print Stock Physical Worksheet**.
    ...
    ![1](../../../static/img/stock/stock-faq/stock-adjustment-take/1.png)
...
2. **Filter** the date, stock group or others **information** that you want to do for the stock take, please **make sure that you have choose the correct location and batch if you have this 2 modules**.
    ...
    ![2](../../../static/img/stock/stock-faq/stock-adjustment-take/2.png)

3. Click on **Apply and Preview**.

    ![3](../../../static/img/stock/stock-faq/stock-adjustment-take/3.png)
...
5. After complete update the stock take report, click on **Stock > Stock Adjustment > Drag Out Book Qty and Physical Qty.**
    ...
    ![4](../../../static/img/stock/stock-faq/stock-adjustment-take/4.png)

    ![5](../../../static/img/stock/stock-faq/stock-adjustment-take/5.png)
...
7. Click on the first item in **Stock Physical Worksheet**, press on **Ctrl + A** on keyboard to select all items. **Then Drag & Drop into Stock Adjustment**.
    ...
    ![6](../../../static/img/stock/stock-faq/stock-adjustment-take/6.png)
...
1. Go to **Stock > Maintain Stock Price Tag**.
    ...
    ![1](../../../static/img/stock/stock-faq/stock-price-tag/1.png)

2. **Create category** of the customer that you want.

    ![2](../../../static/img/stock/stock-faq/stock-price-tag/2.png)
...
3. Edit Customer Price Tag.
   ...
   - After create the category of the customer at maintain stock price tag then click on **Customer > Maintain Customer > Edit the Price Tag and assign accordingly**.
    ...
    ![3](../../../static/img/stock/stock-faq/stock-price-tag/3.png)
...
4. Assign Customer Price Tag.
   ...
   - Click into **Stock > Maintain Stock Item > Edit and click in the Cust Price Tag then assign accordingly**.
    ...
    ![4](../../../static/img/stock/stock-faq/stock-price-tag/4.png)
...
![1](../../../static/img/stock/stock-faq/stock-reorder/1.png)
...
![2](../../../static/img/stock/stock-faq/stock-reorder/2.png)
...
![3](../../../static/img/stock/stock-faq/stock-reorder/3.png)
...
![4](../../../static/img/stock/stock-faq/stock-reorder/4.png)
...
- Please go to Stock > Maintain Stock Item > Edit > Checked Serial No if this item you would like to control serial number.
    ...
    ![1](../../../static/img/stock/stock-faq/stock-serial-no/1.png)
...
1. Click on + (Green Icon) > Manually Enter at Empty Box.
    ...
    ![2](../../../static/img/stock/stock-faq/stock-serial-no/2.png)

### - Method 2 : Import from Notepad / Word

1. Enter the Serial No at the notepad.

    ![3](../../../static/img/stock/stock-faq/stock-serial-no/3.png)

2. Click Import.

    ![4](../../../static/img/stock/stock-faq/stock-serial-no/4.png)

3. Select Notepad where you have saved to.

    ![5](../../../static/img/stock/stock-faq/stock-serial-no/5.png)

4. Click Ok.

    ![6](../../../static/img/stock/stock-faq/stock-serial-no/6.png)

### - Method 3 : Generator

1. Click on Generator.

    ![7](../../../static/img/stock/stock-faq/stock-serial-no/7.png)
...
2. Format = Serial No Format.
    ...
    ![8](../../../static/img/stock/stock-faq/stock-serial-no/8.png)

3. Here the output.

    ![9](../../../static/img/stock/stock-faq/stock-serial-no/9.png)

4. **Sales** > Delivery Order > Click Add.

    ![10](../../../static/img/stock/stock-faq/stock-serial-no/10.png)
...
![update-gl-stock-value-smeb](../../../static/img/stock/stock-faq/stock-month-end-balance/update-gl-stock-value-smeb.png)

- **Solution**
1. Ensure all the **stock group** has defined a **Stock Account**.

![update-gl-stock-value-smeb1](../../../static/img/stock/stock-faq/stock-month-end-balance/update-gl-stock-value-smeb1.png)

2. Apply the Stock Month End again and click **Update** button.

![update-gl-stock-value-smeb2](../../../static/img/stock/stock-faq/stock-month-end-balance/update-gl-stock-value-smeb2.png)
