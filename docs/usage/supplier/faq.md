...
![supplier-faq-add-reference2-1](../../../static/img/usage/supplier/faq/supplier-faq-add-ref2-1.jpg)

**Solution:**

:::note NOTE:
Required SQL Account v784 & above and the following additional modules:
...
2. Add the JomPAY Ref 2 field under **Supplier | Supplier Payment | Payment Fields**.
   ...
   ![supplier-faq-add-reference2-2](../../../static/img/usage/supplier/faq/supplier-faq-add-ref2-2.jpg)

3. Create **Quick Form** and add the UDF_JomPay_Ref2.

   ![supplier-faq-add-reference2-3](../../../static/img/usage/supplier/faq/supplier-faq-add-ref2-3.jpg)

4. At **Supplier Payment**, key in the bill no into UDF_JomPAY_Ref2 under JOMPAY tab.

   ![supplier-faq-add-reference2-4](../../../static/img/usage/supplier/faq/supplier-faq-add-ref2-4.jpg)

5. JomPAY Ref 2 will be captured in the bank JomPAY payment format.

   ![supplier-faq-add-reference2-5](../../../static/img/usage/supplier/faq/supplier-faq-add-ref2-5.jpg)
