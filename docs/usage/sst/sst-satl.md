...
Sales Tax is a **tax charged** and levied on:

- Taxable goods manufactured in Malaysia by a taxable person and sold, used or disposed of by them;
...
- **Goods** refers to all kinds of movable property.

- **Taxable goods** refers to goods that are not specifically exempted from sales tax; i.e goods which are not listed in Sales Tax (Goods Exempted From Sales Tax) Order 2018.
