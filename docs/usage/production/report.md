...
1. Go to **Production > Job Order Listing**.
...
1. Go to **Production > Outstanding Production Document Listing**.
...
1. Go to **Production > BOM Relation**.
...
1. Go to **Production > BOM Listing**.
...
7. Preview the report. Click the **Detail** icon to see the detailed item information for each document.
...
1. Go to **Production > BOM Material Usage**.
...
1. Go to **Production > BOM Planner**.
...
1. Go to **Production > BOM Wastage Report**.
